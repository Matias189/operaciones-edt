...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-header bg-gradient-lightblue shadow">
            <h3 class="card-title"><i class="fas fa-fw fa-pencil-alt"></i> Solicitar requerimiento</h3>
        </div>

        <form action="/departamento" method="POST" enctype="multipart/form-data" id="form">
            @csrf
            <div class="card-body">
