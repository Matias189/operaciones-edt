...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-header bg-gradient-lightblue shadow">
            <h3 class="card-title"><i class="fas fa-fw fa-clipboard"></i> Requerimiento N° {{$petition->id}}</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                ...
                @if($petition->category->priority->name == 'Alta')
                    <li class="list-group-item"> <strong>Prioridad : </strong> <span class="badge bg-gradient-secondary">{{$petition->category->priority->name}}</span></li> 
                @elseif($petition->category->priority->name == 'Media')
                    <li class="list-group-item"> <strong>Prioridad : </strong> <span class="badge bg-gradient-secondary">{{$petition->category->priority->name}}</span></li> 
                @endif
                ...
                @elseif($petition->status->name == 'Pendiente')
                    <li class="list-group-item"> <strong>Estado : </strong> <span class="badge bg-gradient-warning">{{$petition->status->name}}</span></li> 
                ...
                @if($petition->note !='')
                    <li class="list-group-item"><strong> {{$petition->note}}</strong></li>
                @endif
